...
menoBox <- ggplot(data, aes(x = recur, y = rtime, fill=recur, linetype=meno,colour=meno)) + geom_boxplot(lwd=0.75)+ scale_fill_manual(values=c("darkgreen", "darkred")) + scale_colour_manual(values=c("black","black"))
menoBox
chemoBox <- ggplot(data, aes(x = recur, y = rtime, fill=recur, linetype=chemo,colour=chemo)) + geom_boxplot(lwd=0.75)+ scale_fill_manual(values=c("darkgreen", "darkred")) + scale_colour_manual(values=c("black","black"))
chemoBox
sizeBox <- ggplot(data, aes(x = recur, y = rtime, fill=recur, linetype=size,colour=size)) + geom_boxplot(lwd=0.75)+ scale_fill_manual(values=c("darkgreen", "darkred")) + scale_colour_manual(values=c("black","black","black"))
sizeBox
gradeBox <- ggplot(data, aes(x = recur, y = rtime, fill=recur, linetype=grade,colour=grade)) + geom_boxplot(lwd=0.75)+ scale_fill_manual(values=c("darkgreen", "darkred")) + scale_colour_manual(values=c("black","black"))
gradeBox
hormonBox <- ggplot(data, aes(x = recur, y = rtime, fill=recur, linetype=hormon,colour=hormon)) + geom_boxplot(lwd=0.75)+ scale_fill_manual(values=c("darkgreen", "darkred")) + scale_colour_manual(values=c("black","black"))
hormonBox
```
...
# Basic age
ggplot(data, aes(x = age, y = rtime, color = censored)) +
...
# log(age)
ggplot(data, aes(x = log(age), y = rtime, color = censored)) +
  geom_point() + geom_smooth(formula='y ~ x', method="loess",size=2, se=FALSE) + 
  geom_smooth(formula='y ~ x', method="lm",size=2, se=FALSE) + scale_color_manual(values=c("darkgreen", "red"))

# er
ggplot(data, aes(x = er, y = rtime, color = censored)) +
  geom_point() + geom_smooth(formula='y ~ x', method="loess",size=2, se=FALSE) + 
  geom_smooth(formula='y ~ x', method="lm",size=2, se=FALSE) + scale_color_manual(values=c("darkgreen", "red"))

# log(er)
ggplot(data, aes(x = log(er), y = rtime, color = censored)) +
  geom_point() + geom_smooth(formula='y ~ x', method="loess",size=2, se=FALSE) + 
  geom_smooth(formula='y ~ x', method="lm",size=2, se=FALSE) + scale_color_manual(values=c("darkgreen", "red"))

ggplot(data, aes(x = pgr, y = rtime, color = censored)) +
  geom_point() + geom_smooth(formula='y ~ x', method="loess",size=2, se=FALSE) + 
  geom_smooth(formula='y ~ x', method="lm",size=2, se=FALSE) + scale_color_manual(values=c("darkgreen", "red"))
...
logn = survreg(Surv(rtime, censored) ~ chemo + meno + hormon + age + as.factor(grade) + nodes + pgr, data=data, dist="lognormal")
weib = survreg(Surv(rtime, censored) ~ chemo + meno + hormon + age + as.factor(grade) + nodes + pgr, data=data, dist="weibull")
expon = survreg(Surv(rtime, censored) ~ chemo + meno + hormon + age + as.factor(grade) + nodes + pgr, data=data, dist="exponential")
loglogist = survreg(Surv(rtime, censored) ~ chemo + meno + hormon + age + as.factor(grade) + nodes + pgr, data=data, dist="loglogistic")
