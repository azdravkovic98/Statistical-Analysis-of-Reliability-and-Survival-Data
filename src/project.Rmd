...
##fitting full model
fit_ph1 <- coxph(Surv(dtime, as.numeric(death)) ~ chemo + meno + hormon+as.factor(size)+age+as.factor(grade)+nodes
               +pgr+er, data=data)

# ##Backward variable selection based on p-value
# anova(fit_ph1)
# fit_ph2<-coxph(Surv(dtime,as.numeric(death))~chemo+meno+hormon+as.factor(size)+age+as.factor(grade)+nodes
#                +pgr+rtime+recur, data=data)
# anova(fit_ph2)
# fit_ph3<-coxph(Surv(dtime,as.numeric(death))~chemo+meno+hormon+as.factor(size)+age+as.factor(grade)+nodes
#                +rtime+recur, data=data)
# anova(fit_ph3)
# fit_ph4<-coxph(Surv(dtime,as.numeric(death))~chemo+meno+hormon+as.factor(size)+age+as.factor(grade)
#                +rtime+recur, data=data)
# anova(fit_ph4)
# summary(fit_ph4)
...
#chosen model: Surv(dtime, as.numeric(death)) ~ chemo + meno + hormon + age + as.factor(grade)3 + nodes + pgr

fit_ph4 <- coxph(formula = Surv(dtime, as.numeric(death)) ~ chemo + meno + hormon + age + as.factor(grade) + nodes + pgr, data = data)
summary(fit_ph4)
...
logn = survreg(Surv(dtime,as.numeric(death)) ~ as.factor(chemo) + as.factor(size) + as.factor(grade) + as.factor(hormon) + pgr + er, data=data, dist="lognormal")
weib = survreg(Surv(dtime,as.numeric(death)) ~ as.factor(chemo) + as.factor(size) + as.factor(grade) + as.factor(hormon) + pgr + er, data=data, dist="weibull")
expon = survreg(Surv(dtime,as.numeric(death)) ~ as.factor(chemo) + as.factor(size) + as.factor(grade) + as.factor(hormon) + pgr + er, data=data, dist="exponential")
loglogist = survreg(Surv(dtime,as.numeric(death)) ~ as.factor(chemo) + as.factor(size) + as.factor(grade) + as.factor(hormon) + pgr + er, data=data, dist="loglogistic")
...
```{r}
fitCox <- coxph(Surv(dtime, as.numeric(death)) ~ as.factor(chemo) + as.factor(size) + as.factor(grade) + as.factor(hormon) + pgr + er, data=data)
coef(fitCox)
```
